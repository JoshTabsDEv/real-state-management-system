...
<x-app-layout>
    ...
    <div class="flex items-center justify-center sm">
        <div class="bg-white shadow-md rounded-lg p-8 w-full max-w-md">
            ...
            <form action="{{route('client.apply.submit')}}" method="POST">
                ...
                <div class="mb-6">
                    ...
                    <input type="text"  name="agency_name" id="agency_name" value="{{ old('agency_name') }}" class="border rounded-md px-3 py-2 w-full"
                ...
                <div class="mb-6">
                    ...
                    <input type="text"name="license_number" id="license_number" value="{{ old('license_number') }}" class="border rounded-md px-3 py-2 w-full"
                ...
                <button type="submit" class="bg-black text-white rounded-md px-4 py-2 w-full hover:bg-gray-800">Submit
                    Application</button>
            </form>
        </div>

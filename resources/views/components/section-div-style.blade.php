...
<div class="transition-all duration-300 min-h-screen flex flex-col flex-auto flex-shrink-0 antialiased bg-zinc-300 text-black dark:text-white">
    <div id="dashboardContent" class="h-full ml-0 mb-5 sm:ml-[250px] transition-all duration-300">
        <div class="max-w-full mx-auto">
                <div class="flex w-full p-2 bg-white justify-between sticky top-0 z-10">
                    <div class="ml-2 mt-0.5 font-semibold text-xs text-black uppercase sm:text-xs sm:pt-[7px] truncate md:text-md lg:text-md xl:text-md">
                        {{-- <button id="toggleButton" class="text-black mr-0 px-3 py-1 rounded-md border border-transparent hover:border-blue-500">
                            <i id="toggleIcon" class="fa-solid fa-bars" style="color: #000000;"></i>
                        </button> --}}
                       EstateSphere
                    </div>
